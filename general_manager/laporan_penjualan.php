            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
                  <div class="breadcomb-report">
                      <a href="cetak_laporan_penjualan.php"><button data-toggle="tooltip" data-placement="left" title="Cetak Laporan Penjualan" class="btn"><i class="notika-icon notika-print"></i></button></a>
                  </div>
              </div>
            </div>
          </div>
