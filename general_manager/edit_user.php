<?php
    ...
    $query      = mysqli_query($konek,$qlevel)or die(mysqli_error($konek));
                                            ...
                                            <div class="col-lg-9 col-md-7 col-sm-7 col-xs-12">
                                                <div class="nk-int-st">
                                                    <select name="id_level" class="form-control">
                                                       ...
                                                       <!-- <input type="text" class="form-control" name="id_level" placeholder="ID Level" value="" required><?php echo $show['level']; ?> -->
                                                </div>
                                            </div>
                                        </div>
                                    </div>
