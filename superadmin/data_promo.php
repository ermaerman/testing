							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Data Penumpang Dengan Promo</h2>
                        ...
                        <div class="table-responsive">
                             <form class="form-inline" action="" method="POST">
                              <div class="form-group" style="float: right;">
                                ...
                                <a href="index.php?content=data_promo"><button type="button" class="btn btn-warning"><i class="fa fa-refresh fa-fw"></i></button></a>
                              </div>
                            </form>
                            <!-- <?php
                              $date = date('Y-m-d');
                               ...
                               if($_SERVER['REQUEST_METHOD'] == "POST") {
                                  ...
                                  <div style="float:right;">
                                    <ul class="pagination pagination-sm" style="margin: 0">
                                      ...
                                      for ($i=1; $i <= $jml_hal; $i++) {
                                        if ($i != $hal) {
                                          echo "<li><a href=\"index.php?content=data_promo&&hal=$i\">$i</a></li>";
                                        } else {
