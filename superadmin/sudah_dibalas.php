                              ...
                              <!--  <li><a href="index.php?content=list_masuk"><i class="notika-icon notika-mail"></i> Pertanyaan Masuk<span class="pull-right">12</span></a></li> -->
                               <li>
                                 <a href="index.php?content=belum_dibalas">
                                   <i class="notika-icon notika-draft"></i> Belum Dibalas
                               ...
                               <li>
                                 <a href="index.php?content=sudah_dibalas"><i class="notika-icon notika-sent"></i> <b>Sudah Dibalas</b>
                                   <span class="pull-right">
                                     <?php
                                                    ...
                                                    <?php
                                                      ...
                                                      include '../config/koneksi.php';
                                                                 ...
                                                                 if($_SERVER['REQUEST_METHOD'] == "POST") {
                                                                   ...
                                                                   if ($pencarian != '') {
                                                                     $sql = "SELECT * FROM tbl_helpdesk WHERE status='1' AND trash='0' AND nama LIKE '%$pencarian%' OR email LIKE '%$pencarian%' OR inbox LIKE '%$pencarian%' OR outbox LIKE '%$pencarian%' ORDER BY id_helpdesk DESC";
                                                                     $query = $sql;
                                                                     $queryJml = $sql;
                                                                   } else {
                                                                     $query = "SELECT * FROM tbl_helpdesk WHERE status='1' AND trash='0' ORDER BY id_helpdesk DESC LIMIT $posisi, $batas ";
                                                                     $queryJml = "SELECT * FROM tbl_helpdesk WHERE status='1' AND trash='0' ORDER BY id_helpdesk DESC";
                                                                     $no = $posisi + 1;
                                                                   }
                                                                 } else {
                                                                   $query = "SELECT * FROM tbl_helpdesk WHERE status='1' AND trash='0' ORDER BY id_helpdesk DESC LIMIT $posisi, $batas ";
                                                      ...
                                                      $querydata = mysqli_query($konek, $query)or die(mysqli_error());
                                                              ...
                                                              { 
                                                                ...
                                                                while($data = mysqli_fetch_array($querydata)){  
                                                                  ...
                                                                  echo '<td align="center"  width="20"><a data-toggle="tooltip" data-placement="left" title="Pindahkan ke Trash" href=../config/trash.php?id_helpdesk='.$data['id_helpdesk'].'><i class="fa fa-trash fa-fw"></i></a></td>';
                                                                  echo '</tr>';
                                                                  $no++;  
                                                                }
                                                              }
                                               ...
                                               if($_SERVER['REQUEST_METHOD'] == "POST") {
                                                  ...
                                                  <div style="float:right;">
                                                    <ul class="pagination pagination-sm" style="margin: 0">
                                                      ...
                                                      for ($i=1; $i <= $jml_hal; $i++) {
                                                        if ($i != $hal) {
                                                          echo "<li><a href=\"index.php?content=sudah_dibalas&&hal=$i\">$i</a></li>";
                                                        } else {
